...
var y = class extends HTMLElement {
  ...
  requestUpdate(t5, s4, i6, e8 = false, h3) {
    if (void 0 !== t5) {
      ...
      if (false === e8 && (h3 = this[t5]), i6 ??= r7.getPropertyOptions(t5), !((i6.hasChanged ?? f)(h3, s4) || i6.useDefault && i6.reflect && h3 === this._$Ej?.get(t5) && !this.hasAttribute(r7._$Eu(t5, i6)))) return;
      this.C(t5, s4, i6);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t5, s4, { useDefault: i6, reflect: e8, wrapped: h3 }, r7) {
    i6 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t5) && (this._$Ej.set(t5, r7 ?? s4 ?? this[t5]), true !== h3 || void 0 !== r7) || (this._$AL.has(t5) || (this.hasUpdated || i6 || (s4 = void 0), this._$AL.set(t5, s4)), true === e8 && this._$Em !== t5 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t5));
  }
  async _$EP() {
      ...
      if (1 === r7.nodeType) {
        ...
        if (y2.test(r7.tagName)) {
          ...
          if (i7 > 0) {
            ...
            for (let s4 = 0; s4 < i7; s4++) r7.append(t6[s4], c3()), P.nextNode(), d3.push({ type: 2, index: ++l5 });
            r7.append(t6[i7], c3());
          }
        }
...
var H = class {
  ...
  _$AI(t5, i6 = this, s4, e8) {
    ...
    if (void 0 === h3) t5 = M(this, t5, i6, 0), o7 = !a2(t5) || t5 !== this._$AH && t5 !== E, o7 && (this._$AH = t5);
      ...
      const e9 = t5;
      let n5, r7;
      for (t5 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r7 = M(this, e9[s4 + n5], i6, n5), r7 === E && (r7 = this._$AH[n5]), o7 ||= !a2(r7) || r7 !== this._$AH[n5], r7 === A ? t5 = A : t5 !== A && (t5 += (r7 ?? "") + h3[n5 + 1]), this._$AH[n5] = r7;
    }
    o7 && !e8 && this.j(t5);
  }
  j(t5) {
...
var l4 = e6(class extends i5 {
  ...
  update(i6, [t5]) {
    ...
    if (i6.type === t4.PROPERTY) {
      if (t5 === o7[l5]) return E;
    } else if (i6.type === t4.BOOLEAN_ATTRIBUTE) {
      if (!!t5 === o7.hasAttribute(l5)) return E;
    } else if (i6.type === t4.ATTRIBUTE && o7.getAttribute(l5) === t5 + "") return E;
    return p3(i6), t5;
  }
});
...
// test-app/lib/real-world-web-components.entry.js
